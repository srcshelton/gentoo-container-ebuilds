...
IUSE="caps debug ipv6 openntpd parse-clocks readline samba selinux snmp ssl systemd +threads +tmpfiles vim-syntax zeroconf"
...
BDEPEND="
	...
	virtual/pkgconfig
"
PDEPEND="openntpd? ( || ( container-services/openntpd net-misc/openntpd ) )"
...
src_install() {
	...
	if use openntpd ; then
		...
		use tmpfiles && newtmpfiles "${FILESDIR}"/ntp.tmpfiles ntp.conf
