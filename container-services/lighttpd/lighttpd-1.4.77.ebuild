...
LICENSE="BSD GPL-2"
SLOT="0"
#IUSE="+brotli dbi gnutls kerberos ldap libdeflate +lua maxminddb mbedtls +nettle nss +pcre php sasl selinux ssl systemd test tmpfiles unwind webdav xattr +zlib zstd"
#RESTRICT="!test? ( test )"
IUSE="php"
