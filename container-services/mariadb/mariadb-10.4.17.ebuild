...
#IUSE="+backup bindist cracklib debug extraengine galera innodb-bzip2 innodb-lz4 innodb-lzma innodb-lzo innodb-snappy jdbc jemalloc kerberos latin1 libressl mroonga numa odbc oqgraph pam +perl profiling rocksdb selinux +server sphinx sst-mariabackup sst-rsync static systemd systemtap tcmalloc test tokudb xml yassl"
IUSE="latin1 +server"
SUBSLOT="18"
SLOT="10.4/${SUBSLOT:-0}"
