...
SSL_DEPS_SKIP=1
inherit ssl-cert # autotools dot-a eapi9-ver flag-o-matic lua-single systemd toolchain-funcs
...
#IUSE="argon2 cdb kerberos ldap lua lz4 managesieve mysql pam postgres selinux sieve solr sqlite static-libs stemmer suid systemd system-icu test textcat unwind xapian zstd"
...
pkg_postinst() {
	...
	if ver_replacing -lt 2.4 ; then
		...
		ewarn "  https://doc.dovecot.org/2.4.2/installation/upgrade/2.3-to-2.4.html"
	else
