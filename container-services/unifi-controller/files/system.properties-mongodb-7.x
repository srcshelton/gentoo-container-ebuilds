...
#
# Comments below this line will be erased when this unifi instance is started!
#

# Prevent controller from trying to allocate 1GB RAM on startup
# Unifi Cloud Key leaves xms unset but sets xmx to 768(MB)
unifi.xms=128
unifi.xmx=512

# Ensure that mongodb doesn't create huge journal files
#unifi.db.nojournal=true

# Apply strong (Java 8) SSL defaults
unifi.https.sslEnabledProtocols=TLSv1.2
#unifi.https.ciphers=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_256_CBC_SHA,TLS_RSA_WITH_AES_128_CBC_SHA

# Enable HSTS
#unifi.https.hsts=false
#unifi.https.hsts.max_age=
#unifi.https.hsts.preload=false
#unifi.https.hsts.subdomain=false
